#
#  Be sure to run `pod spec lint DemoPodAndCartLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "kmk"
  # s.authors            = { "kmk" => "44663768@163.com" }
  # s.social_media_url   = "http://twitter.com/kmk"
